...
It uses *dleyna-renderer* dbus implementation so it's interface is limited to what's available which unfortunatley doesn't cover all MPRIS2 DBus specification. 
